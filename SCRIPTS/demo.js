document.addEventListener("DOMContentLoaded", function () {
    ...
    const successMessage = document.getElementById("successMessage");  // For success message after task creation
        ...
        if (task && task.name) {
          ...
          row.innerHTML = `
            ...
            <td class="text-center">
              ...
              <button class="btn btn-danger btn-sm delete-btn" onclick="deleteTask(${task.id})" disabled>Delete</button>
            </td>
          `;
    ...
    window.editTask = function (taskId) {
      ...
      if(document.getElementById("editTaskOwner").value == undefined){
        document.getElementById("editTaskOwner").value = '';
      } else{
        document.getElementById("editTaskOwner").value == taskToEdit.owner;
      }
